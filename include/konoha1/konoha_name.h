...
#define FN_currentTimeMillis (MN_OPSIZE+22)
#define FN_currenttimemillis (MN_OPSIZE+22)
...
#define FN_new__array   (MN_OPSIZE+76)
#define FN_new__ARRAY2  (MN_OPSIZE+77)
#define FN_new__array2  (MN_OPSIZE+77)
#define FN_new__LIST    (MN_OPSIZE+78)
#define FN_new__list    (MN_OPSIZE+78)
#define FN_new__MAP     (MN_OPSIZE+79)
#define FN_new__map     (MN_OPSIZE+79)
#define FN_new__TUPLE   (MN_OPSIZE+80)
#define FN_new__tuple   (MN_OPSIZE+80)
#define FN_notNull      (MN_OPSIZE+81)
#define FN_notnull      (MN_OPSIZE+81)
#define FN_null         (MN_OPSIZE+82)
#define FN_offset       (MN_OPSIZE+83)
#define FN_open         (MN_OPSIZE+84)
#define FN_option       (MN_OPSIZE+85)
#define FN_out          (MN_OPSIZE+86)
#define FN_path         (MN_OPSIZE+87)
#define FN_pattern      (MN_OPSIZE+88)
#define FN_pooled       (MN_OPSIZE+89)
#define FN_pop          (MN_OPSIZE+90)
#define FN_print        (MN_OPSIZE+91)
#define FN_println      (MN_OPSIZE+92)
#define FN_proceed      (MN_OPSIZE+93)
#define FN_property     (MN_OPSIZE+94)
...
#define FN_seq          (MN_OPSIZE+107)
#define FN_shuffle      (MN_OPSIZE+108)
#define FN_size         (MN_OPSIZE+109)
#define FN_sort         (MN_OPSIZE+110)
#define FN_split        (MN_OPSIZE+111)
#define FN_start        (MN_OPSIZE+112)
#define FN_startsWith   (MN_OPSIZE+113)
#define FN_startswith   (MN_OPSIZE+113)
#define FN_status       (MN_OPSIZE+114)
#define FN_substring    (MN_OPSIZE+115)
#define FN_swap         (MN_OPSIZE+116)
#define FN_this         (MN_OPSIZE+117)
#define FN_time         (MN_OPSIZE+118)
#define FN_tmr          (MN_OPSIZE+119)
#define FN_to           (MN_OPSIZE+120)
#define FN_trace        (MN_OPSIZE+121)
#define FN_trim         (MN_OPSIZE+122)
#define FN_typeCheck    (MN_OPSIZE+123)
#define FN_typecheck    (MN_OPSIZE+123)
...
#define FN_xdata        (MN_OPSIZE+132)
#define FN_y            (MN_OPSIZE+133)
#define FN_year         (MN_OPSIZE+134)
