...
#define FN_new__array   (MN_OPSIZE+75)
#define FN_new__ARRAY2  (MN_OPSIZE+76)
#define FN_new__array2  (MN_OPSIZE+76)
...
#define FN_random       (MN_OPSIZE+94)
#define FN_randomSeed   (MN_OPSIZE+95)
#define FN_randomseed   (MN_OPSIZE+95)
#define FN_re           (MN_OPSIZE+96)
#define FN_readLine     (MN_OPSIZE+97)
#define FN_readline     (MN_OPSIZE+97)
#define FN_remove       (MN_OPSIZE+98)
#define FN_replace      (MN_OPSIZE+99)
#define FN_reverse      (MN_OPSIZE+100)
#define FN_s            (MN_OPSIZE+101)
#define FN_search       (MN_OPSIZE+102)
#define FN_sec          (MN_OPSIZE+103)
#define FN_seed         (MN_OPSIZE+104)
#define FN_send         (MN_OPSIZE+105)
#define FN_seq          (MN_OPSIZE+106)
...
#define FN_trace        (MN_OPSIZE+120)
#define FN_trim         (MN_OPSIZE+121)
#define FN_typeCheck    (MN_OPSIZE+122)
#define FN_typecheck    (MN_OPSIZE+122)
...
#define FN_x            (MN_OPSIZE+130)
#define FN_xdata        (MN_OPSIZE+131)
#define FN_y            (MN_OPSIZE+132)
#define FN_year         (MN_OPSIZE+133)
