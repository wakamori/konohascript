...
#define FN_currentTimeMillis (MN_OPSIZE+23)
#define FN_currenttimemillis (MN_OPSIZE+23)
#define FN_d            (MN_OPSIZE+24)
#define FN_data         (MN_OPSIZE+25)
#define FN_day          (MN_OPSIZE+26)
#define FN_debug        (MN_OPSIZE+27)
#define FN_decode       (MN_OPSIZE+28)
#define FN_defined      (MN_OPSIZE+29)
#define FN_delegate     (MN_OPSIZE+30)
#define FN_dump         (MN_OPSIZE+31)
#define FN_e            (MN_OPSIZE+32)
#define FN_empty        (MN_OPSIZE+33)
#define FN_enc          (MN_OPSIZE+34)
#define FN_encode       (MN_OPSIZE+35)
#define FN_end          (MN_OPSIZE+36)
#define FN_endsWith     (MN_OPSIZE+37)
#define FN_endswith     (MN_OPSIZE+37)
#define FN_equals       (MN_OPSIZE+38)
#define FN_err          (MN_OPSIZE+39)
#define FN_eval         (MN_OPSIZE+40)
#define FN_event        (MN_OPSIZE+41)
#define FN_exec         (MN_OPSIZE+42)
#define FN_exit         (MN_OPSIZE+43)
#define FN_extract      (MN_OPSIZE+44)
#define FN_f            (MN_OPSIZE+45)
#define FN_flag         (MN_OPSIZE+46)
...
#define FN_hashcode     (MN_OPSIZE+51)
#define FN_hour         (MN_OPSIZE+52)
#define FN_in           (MN_OPSIZE+53)
#define FN_indexOf      (MN_OPSIZE+54)
#define FN_indexof      (MN_OPSIZE+54)
#define FN_init         (MN_OPSIZE+55)
#define FN_initCapacity (MN_OPSIZE+56)
#define FN_initcapacity (MN_OPSIZE+56)
#define FN_insert       (MN_OPSIZE+57)
#define FN_it           (MN_OPSIZE+58)
#define FN_k            (MN_OPSIZE+59)
#define FN_key          (MN_OPSIZE+60)
#define FN_keys         (MN_OPSIZE+61)
#define FN_lastIndexOf  (MN_OPSIZE+62)
#define FN_lastindexof  (MN_OPSIZE+62)
#define FN_length       (MN_OPSIZE+63)
#define FN_listProperties (MN_OPSIZE+64)
#define FN_listproperties (MN_OPSIZE+64)
#define FN_m            (MN_OPSIZE+65)
#define FN_main         (MN_OPSIZE+66)
#define FN_match        (MN_OPSIZE+67)
#define FN_method       (MN_OPSIZE+68)
#define FN_min          (MN_OPSIZE+69)
#define FN_mode         (MN_OPSIZE+70)
#define FN_month        (MN_OPSIZE+71)
#define FN_msg          (MN_OPSIZE+72)
#define FN_mtd          (MN_OPSIZE+73)
#define FN_n            (MN_OPSIZE+74)
#define FN_name         (MN_OPSIZE+75)
#define FN_new          (MN_OPSIZE+76)
#define FN_new__ARRAY   (MN_OPSIZE+77)
#define FN_new__array   (MN_OPSIZE+77)
#define FN_new__ARRAY2  (MN_OPSIZE+78)
#define FN_new__array2  (MN_OPSIZE+78)
#define FN_new__LIST    (MN_OPSIZE+79)
#define FN_new__list    (MN_OPSIZE+79)
#define FN_new__MAP     (MN_OPSIZE+80)
#define FN_new__map     (MN_OPSIZE+80)
#define FN_new__TUPLE   (MN_OPSIZE+81)
#define FN_new__tuple   (MN_OPSIZE+81)
#define FN_notNull      (MN_OPSIZE+82)
#define FN_notnull      (MN_OPSIZE+82)
#define FN_null         (MN_OPSIZE+83)
#define FN_offset       (MN_OPSIZE+84)
#define FN_open         (MN_OPSIZE+85)
#define FN_option       (MN_OPSIZE+86)
#define FN_out          (MN_OPSIZE+87)
#define FN_path         (MN_OPSIZE+88)
#define FN_pattern      (MN_OPSIZE+89)
#define FN_pooled       (MN_OPSIZE+90)
#define FN_pop          (MN_OPSIZE+91)
#define FN_print        (MN_OPSIZE+92)
#define FN_println      (MN_OPSIZE+93)
#define FN_proceed      (MN_OPSIZE+94)
#define FN_property     (MN_OPSIZE+95)
...
#define FN_reverse      (MN_OPSIZE+102)
#define FN_s            (MN_OPSIZE+103)
#define FN_search       (MN_OPSIZE+104)
#define FN_sec          (MN_OPSIZE+105)
#define FN_seed         (MN_OPSIZE+106)
#define FN_send         (MN_OPSIZE+107)
#define FN_seq          (MN_OPSIZE+108)
#define FN_shuffle      (MN_OPSIZE+109)
#define FN_size         (MN_OPSIZE+110)
#define FN_sort         (MN_OPSIZE+111)
#define FN_split        (MN_OPSIZE+112)
#define FN_start        (MN_OPSIZE+113)
#define FN_startsWith   (MN_OPSIZE+114)
#define FN_startswith   (MN_OPSIZE+114)
#define FN_status       (MN_OPSIZE+115)
#define FN_substring    (MN_OPSIZE+116)
#define FN_swap         (MN_OPSIZE+117)
#define FN_this         (MN_OPSIZE+118)
#define FN_time         (MN_OPSIZE+119)
#define FN_tmr          (MN_OPSIZE+120)
#define FN_to           (MN_OPSIZE+121)
#define FN_toCharArray  (MN_OPSIZE+122)
#define FN_tochararray  (MN_OPSIZE+122)
#define FN_toLowerCase  (MN_OPSIZE+123)
#define FN_tolowercase  (MN_OPSIZE+123)
#define FN_toUpperCase  (MN_OPSIZE+124)
#define FN_touppercase  (MN_OPSIZE+124)
#define FN_trace        (MN_OPSIZE+125)
#define FN_trim         (MN_OPSIZE+126)
#define FN_typeCheck    (MN_OPSIZE+127)
#define FN_typecheck    (MN_OPSIZE+127)
#define FN_u            (MN_OPSIZE+128)
#define FN_urn          (MN_OPSIZE+129)
#define FN_v            (MN_OPSIZE+130)
#define FN_value        (MN_OPSIZE+131)
#define FN_vargs        (MN_OPSIZE+132)
#define FN_w            (MN_OPSIZE+133)
#define FN_write        (MN_OPSIZE+134)
#define FN_x            (MN_OPSIZE+135)
#define FN_xdata        (MN_OPSIZE+136)
#define FN_y            (MN_OPSIZE+137)
#define FN_year         (MN_OPSIZE+138)
#define FN_z            (MN_OPSIZE+139)
#define K_TFIELD_SIZE   140
...
#define MN_toLowerCase  FN_tolowercase
...
#define MN_toUpperCase  FN_touppercase
#define MN_close        FN_close
#define MN_new__ARRAY2  FN_new__array2
...
#define MN_toCharArray  FN_tochararray
...
#define MN_length       FN_length
#define MN_decode       FN_decode
#define MN_currentTimeMillis FN_currenttimemillis
